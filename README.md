<img width="1440" alt="スクリーンショット 2024-10-25 19 08 15" src="https://github.com/user-attachments/assets/fa746760-f6b8-4a5a-8292-1ffb83d063b8" />
...
useMemo と useCallback を使用したパフォーマンス最適化について学習します。

また、React.memo との組み合わせによる、不要な再計算・再レンダリングをなくす実装を確認してください。
